...
def process_data(cur, conn, filepath, func):
    """
    Description: This function can be used to process the log_data/song_data & to create the time/users dim tables & songplays fact table.
    """
...
def main():
    """
    Description: This function can be used insert songs and logs into our database
    """
